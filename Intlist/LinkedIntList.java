...
public class LinkedIntList {
    ...
    public static void firstToLast(LinkedIntList L) {
        if (L.front != null) {
            ...
            // Brings current all the way to the end of the list
            curr.next = new ListNode(L.front.data);
    ...
    public static LinkedIntList concatenated(LinkedIntList A, LinkedIntList B) {
        LinkedIntList concat = new LinkedIntList();
        if (A.front != null && B.front != null) {
            ListNode curr = A.front; // temp to iterate through A.
            concat.front = new ListNode(curr.data); // Creates a new node with the first node of A
            ListNode temp = concat.front; // Used to move through elements of concat as they are created
            while (curr.next != null) {
                curr = curr.next;
            ...
            concat.front = B.front;
        } else {
            concat.front = A.front;
        }
